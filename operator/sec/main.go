...
func init() {
	...
	utilruntime.Must(ralapiov1alpha1.AddToScheme(scheme))
...
func main() {
	...
	if err = (&controllers.SecReconciler{
		Client: mgr.GetClient(),
		Scheme: mgr.GetScheme(),
	}).SetupWithManager(mgr); err != nil {
		setupLog.Error(err, "unable to create controller", "controller", "Sec")
		os.Exit(1)
	}
